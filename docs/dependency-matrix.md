...
| Next.js / React / TypeScript | App Router 网页及 API | Web 包固定 15.5.26 / 19.1.4 / 5.9.2；npm 锁文件，根 pnpm 待 RB-02 | C/D；[C 本地报告](../tests/reports/2026-09-25-member-c.md) |
...
| PostgreSQL / Supabase Storage | 私有资料和投影 | PostgreSQL 17.11；PGlite 0.5.8；SQL 迁移及私有 Storage 已实现 | D；[D local slice](../tests/reports/2026-09-26-member-d.md)，云端 Supabase/TS04 待验证 |
...
## D Backend Dependencies, 2026-09-26

All versions are pinned in the npm lockfiles. Executed evidence is in the [D report](../tests/reports/2026-09-26-member-d.md).

| Official source | Version | License | Purpose and validation |
| --- | --- | --- | --- |
| [PGlite](https://github.com/electric-sql/pglite) | 0.5.8 | Apache-2.0 | Local durable PostgreSQL engine; migrations, reopen and concurrency tests |
| [node-postgres](https://github.com/brianc/node-postgres) | 8.23.0 | MIT | Shared database adapter; actual PostgreSQL two-pool integration |
| [PostgreSQL](https://www.postgresql.org/) | 17.11; image digest in infra/compose.yaml | PostgreSQL License | Disposable integration database |
| [Zod](https://github.com/colinhacks/zod) | 4.6.5 | MIT | Request validation, malformed amount and ACL tests |
| [fflate](https://github.com/101arrowz/fflate) | 0.8.3 | MIT | Private ZIP generation and integrity tests |
| [Hardhat](https://github.com/NomicFoundation/hardhat) | 3.18.0 | MIT | Test-only real EVM JSON-RPC execution |
| [solc-js](https://github.com/ethereum/solc-js) | 0.8.24 | MIT | Compile repository contracts and generate ABI |
| [pg types](https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/pg) | 8.15.6 | MIT | Server typechecking |
| [Next.js](https://github.com/vercel/next.js) | 15.5.26 | MIT | API route and security patch upgrade; production build |
